...
class DataService {
  ...
  static const List<SportClub> clubs = [
    SportClub(
      id: 'c1', name: 'Victory FC Club', initials: 'VF',
      color: Color(0xFF4CAF50), distanceKm: 1.2,
      openTime: '06:00 AM', closeTime: '10:00 PM',
      ...
      totalCourts: 3, pricePerHour: 15.0,
    ),
    SportClub(
      id: 'c2', name: 'Smash Badminton', initials: 'SB',
      color: Color(0xFF29B6F6), distanceKm: 2.5,
      openTime: '07:00 AM', closeTime: '11:00 PM',
      ...
      totalCourts: 6, pricePerHour: 12.0,
    ),
    SportClub(
      id: 'c3', name: 'Slam Dunk Arena', initials: 'SD',
      color: Color(0xFFFF9800), distanceKm: 4.1,
      openTime: '07:00 AM', closeTime: '11:00 PM',
      ...
      totalCourts: 5, pricePerHour: 18.0,
    ),
    SportClub(
      id: 'c4', name: 'SportZone Hub', initials: 'SZ',
      color: Color(0xFFFF5722), distanceKm: 6.8,
      openTime: '06:00 AM', closeTime: '12:00 AM',
      ...
      totalCourts: 12, pricePerHour: 10.0,
    ),
    SportClub(
      id: 'c5', name: 'FitZone Gym', initials: 'FZ',
      color: Color(0xFF9C27B0), distanceKm: 3.3,
      openTime: '05:00 AM', closeTime: '11:00 PM',
      ...
      totalCourts: 4, pricePerHour: 25.0,
    ),
  ];
  ...
  static const List<SportBooking> bookings = [
    SportBooking(
      id: 'b1', title: 'Evening Football Rally',
      ownerName: 'Carlos Mendez', ownerInitials: 'CM',
      ...
      bookedSlots: 3, totalSlots: 10,
    ),
    SportBooking(
      id: 'b2', title: 'Badminton & Tennis Night',
      ownerName: 'Sarah Kim', ownerInitials: 'SK',
      ...
      openTime: '10:00 AM', closeTime: '09:00 PM',
      bookedSlots: 2, totalSlots: 4,
    ),
    SportBooking(
      id: 'b3', title: 'Multi-Sport Arena',
      ownerName: 'David Osei', ownerInitials: 'DO',
      ...
      openTime: '07:00 AM', closeTime: '11:00 PM',
      bookedSlots: 5, totalSlots: 12,
    ),
    SportBooking(
      id: 'b4', title: '3v3 Basketball Open',
      ownerName: 'Priya Sharma', ownerInitials: 'PS',
      ...
      openTime: '09:00 AM', closeTime: '08:00 PM',
      bookedSlots: 4, totalSlots: 6,
    ),
  ];
  ...
  static const List<Trainer> trainers = [
    Trainer(index: 1, name: 'Marcus Webb',   specialty: 'Strength & Conditioning',
        imageUrl: 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=400&q=80'),
    Trainer(index: 2, name: 'Priya Nair',    specialty: 'Yoga & Flexibility',
        imageUrl: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=400&q=80'),
    Trainer(index: 3, name: 'Jake Sullivan', specialty: 'CrossFit & HIIT',
        imageUrl: 'https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?w=400&q=80'),
    Trainer(index: 4, name: 'Aisha Okafor',  specialty: 'Nutrition & Wellness',
  ...
  static List<SportClub> filteredClubs(String categoryId) {
    ...
    return clubs.where((c) => c.sports
        .any((s) => s.toLowerCase() == categoryId)).toList();
  }

  static List<SportBooking> filteredBookings(String categoryId) {
    if (categoryId == 'all') return bookings;
    return bookings.where((b) => b.sportTypes
        .any((s) => s.toLowerCase() == categoryId)).toList();
  }
}
