  ...
  void _openFull(BuildContext ctx) {
    Navigator.of(ctx).push(PageRouteBuilder(
      ...
      pageBuilder: (_, __, ___) => _FullScreenViewer(
          imageUrls: widget.imageUrls, initialIndex: _page),
                ...
                errorBuilder: (_, __, ___) =>
                    Container(color: AppTheme.kCardAlt,
                        child: const Icon(Icons.image_not_supported,
                            color: AppTheme.kTextSub, size: 36)),
                loadingBuilder: (_, c, p) => p == null ? c :
                    Container(color: AppTheme.kCardAlt,
                        child: const Center(child: CircularProgressIndicator(
                            color: AppTheme.kAccent, strokeWidth: 2))),
              ),
            ),
...
class _FullScreenViewerState extends State<_FullScreenViewer>
  ...
  @override
  void dispose() { _ctrl.dispose(); _fade.dispose(); super.dispose(); }
