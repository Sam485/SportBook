...
class _ClubCardState extends State<ClubCard> {
  ...
  void _onDragUpdate(DragUpdateDetails d) {
    ...
    _ctrl.position.moveTo(
        _ctrl.offset - (d.primaryDelta ?? 0), clamp: false);
  }
            ...
            child: ClipRRect(
              ...
              child: SizedBox(
                ...
                child: Stack(fit: StackFit.expand, children: [
                  ...
                  // Open/close badge
                  Positioned(
                      top: 8, left: 10, child: _openCloseBadge()),
            ...
            child:
                    ...
                    children: [
                      ...
                      Row(children: [
                        ...
                        const Icon(Icons.lock_outline,
                            color: AppTheme.kTextSub, size: 11),
                        const SizedBox(width: 2),
                        Text(c.closeTime,
                            style: const TextStyle(
                                color: AppTheme.kTextSub, fontSize: 10)),
                      ]),
                    ],
                  ),
                ),
              ...
              Row(children: [
                const Icon(Icons.place_outlined,
                    color: AppTheme.kAccent, size: 12),
              ...
              Row(children: [
                ...
                Text('${c.distanceKm} km away',
                    style: const TextStyle(
                        color: AppTheme.kTextSub, fontSize: 11)),
                const Spacer(),
                GestureDetector(
  ...
  Widget _openCloseBadge() {
    ...
    final isOpen = nowM >= parse(widget.club.openTime) &&
