...
class SportClub {
  ...
  const SportClub(
      this.name, this.initials, this.color, this.distanceKm,
      this.openTime, this.closeTime, this.venue, this.description,
      this.sports, this.imageUrls, this.totalCourts, this.pricePerHour);
}
...
class SportBooking {
  ...
  const SportBooking(
      this.title, this.ownerName, this.ownerInitials, this.ownerColor,
      this.sportTypes, this.venue, this.imageUrls,
      this.openTime, this.closeTime, this.bookedSlots, this.totalSlots);
...
class _HomePageState extends State<HomePage> {
  ...
  static const List<SportClub> allClubs = [
    SportClub(
      'Victory FC Club', 'VF', Color(0xFF4CAF50), 1.2,
      '06:00 AM', '10:00 PM', 'Central Park Field A',
    ...
    SportClub(
      'Smash Badminton', 'SB', Color(0xFF29B6F6), 2.5,
      '07:00 AM', '11:00 PM', 'SportZone Hall 2',
    ...
    SportClub(
      'Slam Dunk Arena', 'SD', Color(0xFFFF9800), 4.1,
      '07:00 AM', '11:00 PM', 'Downtown Arena Court 1',
    ...
    SportClub(
      'SportZone Hub', 'SZ', Color(0xFFFF5722), 6.8,
      '06:00 AM', '12:00 AM', 'Riverside Sports Complex',
  ...
  static const List<SportBooking> allBookings = [
    SportBooking(
      'Evening Football Rally', 'Carlos Mendez', 'CM', Color(0xFF4CAF50),
      ['Football'], 'Central Park Field A',
      [
        'https://images.unsplash.com/photo-1510051640316-cee39563ddab?w=800&q=80',
        'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=800&q=80',
        'https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?w=800&q=80',
      ],
      '08:00 AM', '10:00 PM', 3, 10,
    ),
    SportBooking(
      'Badminton & Tennis Night', 'Sarah Kim', 'SK', Color(0xFF29B6F6),
      ['Badminton', 'Tennis'], 'SportZone Hall 2',
      [
        'https://images.unsplash.com/photo-1626224583764-f87db24ac4ea?w=800&q=80',
        'https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=800&q=80',
      ],
      '10:00 AM', '09:00 PM', 2, 4,
    ),
    SportBooking(
      'Multi-Sport Arena', 'David Osei', 'DO', Color(0xFFFF9800),
      ...
      '07:00 AM', '11:00 PM', 5, 12,
    ),
    SportBooking(
      '3v3 Basketball Open', 'Priya Sharma', 'PS', Color(0xFFFF5722),
      ['Basketball'], 'Downtown Arena Court 1',
      [
        'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=800&q=80',
        'https://images.unsplash.com/photo-1504450758481-7338eba7524a?w=800&q=80',
      ],
      '09:00 AM', '08:00 PM', 4, 6,
    ),
  ];
          ...
          Expanded(
            child: CustomScrollView(
              ...
              slivers: [
                ...
                SliverToBoxAdapter(child: _sectionHead('Clubs Nearby', 'View All')),
                SliverToBoxAdapter(child: _nearbyCLubs()),
                SliverToBoxAdapter(child: _sectionHead('Upcoming Bookings', 'View All')),
    ...
    child: Row(children: [
      Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: kAccent.withOpacity(0.3), blurRadius: 10)],
        ),
        padding: const EdgeInsets.all(2),
        child: Container(
          decoration: const BoxDecoration(shape: BoxShape.circle, color: kCard),
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: const [
          ...
          SizedBox(width: 3),
          Text('New York', style: TextStyle(color: kAccent, fontSize: 13, fontWeight: FontWeight.w600)),
          Icon(Icons.keyboard_arrow_down_rounded, color: kAccent, size: 16),
        ]),
      ]),
      const Spacer(),
      Container(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          colors: [const Color(0xFF1A5276), kAccent.withOpacity(0.85)],
          begin: Alignment.topLeft, end: Alignment.bottomRight,
        ),
        boxShadow: [BoxShadow(color: kAccent.withOpacity(0.25), blurRadius: 20, offset: const Offset(0, 8))],
      ),
      child: Stack(children: [
        Positioned(right: -24, top: -24, child: _circle(130, 0.08)),
        Positioned(right: 30, bottom: -36, child: _circle(90, 0.06)),
        const Positioned(right: 28, top: 16, child: Text('⚽', style: TextStyle(fontSize: 28))),
        const Positioned(right: 80, bottom: 16, child: Text('🏸', style: TextStyle(fontSize: 22))),
        const Positioned(right: 16, bottom: 16, child: Text('🏀', style: TextStyle(fontSize: 20))),
        const Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
              mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                SizedBox(height: 8),
                Text('Find courts, book slots, meet players',
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: sel
                    ? [BoxShadow(color: kAccent.withOpacity(0.3), blurRadius: 8, offset: const Offset(0, 3))]
                    : null,
              ),
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                Text(categories[i].emoji, style: const TextStyle(fontSize: 15)),
  ...
  Widget _sectionHead(String title, String action) => Padding(
    ...
    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      ...
      Text(action, style: const TextStyle(color: kAccent, fontSize: 13, fontWeight: FontWeight.w700)),
    ]),
  );
    ...
    if (list.isEmpty) {
      return Padding(
        ...
        child: Container(
          ...
          child: const Center(child: Text('No clubs nearby for this sport',
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const SizedBox(height: 2),
              Row(children: [
                const Icon(Icons.lock_open_outlined, color: kAccent, size: 11),
                const SizedBox(width: 2),
                Text(c.openTime, style: const TextStyle(color: kAccent, fontSize: 10, fontWeight: FontWeight.w600)),
                const SizedBox(width: 6),
                Container(width: 3, height: 3,
                    decoration: const BoxDecoration(color: kTextSub, shape: BoxShape.circle)),
                const SizedBox(width: 6),
                const Icon(Icons.lock_outline, color: kTextSub, size: 11),
                const SizedBox(width: 2),
                Text(c.closeTime, style: const TextStyle(color: kTextSub, fontSize: 10)),
              ]),
            ])),
          ]),
          ...
          Row(children: [
            ...
            Expanded(child: Text(c.venue, style: const TextStyle(color: Colors.white70, fontSize: 11),
                overflow: TextOverflow.ellipsis)),
          ]),
          const SizedBox(height: 6),
          Row(children: [
            ...
            const SizedBox(width: 4),
            Text('${c.distanceKm} km away', style: const TextStyle(color: kTextSub, fontSize: 11)),
            const Spacer(),
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: kAccent.withOpacity(0.35), blurRadius: 8, offset: const Offset(0, 3))],
                ),
                child: const Text('Book', style: TextStyle(color: kBg, fontSize: 11, fontWeight: FontWeight.w800)),
              ),
            ),
          ]),
        ]),
      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          InkWell(
            ...
            highlightColor: kAccent.withOpacity(0.04),
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  Container(
                    ...
                    alignment: Alignment.center,
                    child: Text(b.ownerInitials, style: const TextStyle(color: Colors.white,
                        fontSize: 12, fontWeight: FontWeight.w800)),
                  ),
                  const SizedBox(width: 10),
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text(b.title, style: const TextStyle(color: Colors.white, fontSize: 15,
                        fontWeight: FontWeight.w800, letterSpacing: -0.2),
                        overflow: TextOverflow.ellipsis),
                    const SizedBox(height: 4),
                    Row(children: [
                      const Icon(Icons.lock_open_outlined, color: kAccent, size: 12),
                      const SizedBox(width: 3),
                      Text(b.openTime, style: const TextStyle(color: kAccent, fontSize: 11.5, fontWeight: FontWeight.w600)),
                      const SizedBox(width: 8),
                      Container(width: 3, height: 3,
                          decoration: const BoxDecoration(color: kTextSub, shape: BoxShape.circle)),
                      const SizedBox(width: 8),
                      const Icon(Icons.lock_outline, color: kTextSub, size: 12),
                      const SizedBox(width: 3),
                      Text(b.closeTime, style: const TextStyle(color: kTextSub, fontSize: 11.5)),
                    ]),
                  ])),
                  const Icon(Icons.keyboard_arrow_right_rounded, color: kTextSub, size: 18),
                ]),
                const SizedBox(height: 12),
                Container(height: 1, color: kBorder),
                const SizedBox(height: 12),
                Row(children: [
                  const Icon(Icons.place_outlined, color: kAccent, size: 14),
                  const SizedBox(width: 5),
                  Expanded(child: Text(b.venue, style: const TextStyle(color: Colors.white70, fontSize: 12.5),
                      overflow: TextOverflow.ellipsis)),
                ]),
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Padding(
                    ...
                    child: Icon(Icons.sports_outlined, color: kAccent, size: 13),
                  ),
                  const SizedBox(width: 5),
                  Expanded(
                    child: Wrap(spacing: 6, runSpacing: 6,
                      children: unique.map((s) => Container(
                        ...
                        child: Text('${_emoji(s)} $s', style: const TextStyle(
      ...
      builder: (ctx) => _CourtBookingSheet(
        ...
        onConfirm: (sport, court, date, time) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text('✅  $name · Court $court · ${_fmtDate(date)} · $time'),
...
const _kTrainers = [
  {'name': 'Marcus Webb',   'spec': 'Strength & Conditioning', 'img': 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=400&q=80'},
  {'name': 'Priya Nair',    'spec': 'Yoga & Flexibility',       'img': 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=400&q=80'},
  {'name': 'Jake Sullivan', 'spec': 'CrossFit & HIIT',          'img': 'https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?w=400&q=80'},
  {'name': 'Aisha Okafor',  'spec': 'Nutrition & Wellness',     'img': 'https://images.unsplash.com/photo-1594381898411-846e7d193883?w=400&q=80'},
];
...
class _CourtBookingSheet extends StatefulWidget {
  ...
  final void Function(String sport, int court, DateTime date, String timeRange) onConfirm;

  const _CourtBookingSheet({
    required this.name, required this.initials, required this.color,
    required this.venue, required this.openTime, required this.closeTime,
    required this.totalCourts, required this.pricePerHour,
    required this.sports, required this.dates,
    required this.emojiFor, required this.onConfirm, required List<String> timeSlots,
  });
...
class _CourtBookingSheetState extends State<_CourtBookingSheet> {
  ...
  void initState() {
    ...
    _bookedRanges['1-0'] = [[9, 11]];
    _bookedRanges['2-0'] = [[14, 16]];
  }
  ...
  static const int _kEndH   = 23;  // 11:00 PM (last selectable hour)

  // All hours 12 AM – 11 PM (24 slots)
  List<int> get _allHours =>
  ...
  void _resetTime() => setState(() { _startH = null; _endH = null; });
    ...
    child: Column(children: [
      ...
      Row(children: [
        Container(
          ...
          alignment: Alignment.center,
          child: Text(widget.initials, style: const TextStyle(
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(children: [
            const Icon(Icons.place_outlined, color: kAccent, size: 12),
            const SizedBox(width: 3),
            Expanded(child: Text(widget.venue,
        ...
        Container(
          ...
          decoration: BoxDecoration(color: kCardAlt,
              borderRadius: BorderRadius.circular(20),
              border: Border.all(color: kBorder)),
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            const Icon(Icons.access_time_rounded, color: kAccent, size: 12),
            const SizedBox(width: 4),
  ...
  Widget _stepProgress() {
    final steps  = [
      _isGym ? 'Trainer' : 'Court',
      'Date',
      'Time',
    ];
    final cur    = _court == null ? 0 : _canConfirm ? 2 : 1;
    ...
    return Row(children: List.generate(steps.length * 2 - 1, (i) {
      ...
      return Column(mainAxisSize: MainAxisSize.min, children: [
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: done ? kAccent : active ? kAccent.withOpacity(0.2) : kCardAlt,
            border: Border.all(color: done || active ? kAccent : kBorder, width: 1.5),
          ),
          alignment: Alignment.center,
          child: done
  ...
  Widget _sectionLabel(String title, {bool done = false, String? hint}) =>
      Row(children: [
  ...
  Widget _courtGrid() {
    ...
    return GridView.builder(
      ...
      itemBuilder: (_, i) {
        ...
        return GestureDetector(
          onTap: () => setState(() { _court = num; _resetTime(); }),
          child: AnimatedContainer(
            duration: const Duration(milliseconds: 200),
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  ...
                  width: sel ? 2.5 : 1),
              boxShadow: sel
                  ? [BoxShadow(color: kAccent.withOpacity(0.35),
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [Colors.transparent,
                        sel ? const Color(0xCC0A1828) : const Color(0x880A1828)],
  ...
  Widget _trainerGrid() {
    return GridView.builder(
      ...
      itemBuilder: (_, i) {
        ...
        return GestureDetector(
          onTap: () => setState(() { _court = i + 1; _resetTime(); }),
          child: AnimatedContainer(
            duration: const Duration(milliseconds: 200),
            clipBehavior: Clip.hardEdge,
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(16),
              border: Border.all(
                  color: sel ? kAccent : kBorder, width: sel ? 2.5 : 1),
              boxShadow: sel
                  ? [BoxShadow(color: kAccent.withOpacity(0.35),
                  blurRadius: 10, offset: const Offset(0, 4))]
                  : null,
            ...
            child: Stack(fit: StackFit.expand, children: [
              Image.network(t['img']!, fit: BoxFit.cover,
                  errorBuilder: (_, __, ___) => Container(color: kCardAlt)),
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (_, i) {
          ...
          final isToday = DateUtils.isSameDay(d, DateTime.now());
          return GestureDetector(
            onTap: () => setState(() { _dateIdx = i; _resetTime(); }),
            child: AnimatedContainer(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                Text(isToday ? 'Today' : days[d.weekday % 7],
                    style: TextStyle(color: sel ? kBg : kTextSub,
                        fontSize: 9.5, fontWeight: FontWeight.w600)),
                const SizedBox(height: 2),
                Text('${d.day}', style: TextStyle(
                    color: sel ? kBg : Colors.white,
                    fontSize: 19, fontWeight: FontWeight.w800)),
                Text(months[d.month - 1], style: TextStyle(
                    color: sel ? kBg.withOpacity(0.6) : kTextSub,
                    fontSize: 9.5)),
              ]),
            ),
          );
  ...
  Widget _timeRangePicker() {
    if (_court == null) {
      return Container(
        ...
        decoration: BoxDecoration(
            color: kCardAlt, borderRadius: BorderRadius.circular(14)),
        child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Icon(Icons.info_outline, color: kTextSub, size: 15),
          SizedBox(width: 8),
          Text('Select a court first',
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      // ── Start row ────────────────────────────────────────────────────
      _rowLabel('Start', Icons.play_arrow_rounded, const Color(0xFF4CAF50), _startH),
      const SizedBox(height: 8),
      SizedBox(
        height: 44,
        child: ListView.builder(
          ...
          itemBuilder: (_, i) {
            ...
            final sel = _startH == h;
            final inR = _startH != null && _endH != null
                && h > _startH! && h < _endH!;
            return GestureDetector(
              onTap: () => setState(() {
                _startH = h;
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: sel ? const Color(0xFF4CAF50)
                      : inR ? kAccent.withOpacity(0.15)
                      : kCardAlt,
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color: sel ? const Color(0xFF4CAF50)
                        : inR ? kAccent.withOpacity(0.4)
                        : kBorder,
                  ),
                ),
                child: Text(_fmtH(h),
                    style: TextStyle(
                      color: sel ? Colors.white : inR ? kAccent : Colors.white60,
      ...
      SizedBox(
        ...
        child: endHours.isEmpty
            ? const Center(child: Text('No available end times',
          ...
          itemBuilder: (_, i) {
            final h   = endHours[i];
            final sel = _endH == h;
            final inR = _endH != null && h > (_startH ?? 0) && h < _endH!;
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 10),
                decoration: BoxDecoration(
                  color: sel ? Colors.redAccent
                      : inR ? kAccent.withOpacity(0.12)
                      : kCardAlt,
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color: sel ? Colors.redAccent
      ...
      if (_startH != null && _endH != null && _endH! > _startH!) ...[
        ...
        Container(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            ...
            const SizedBox(width: 6),
            Text('$_timeRangeLabel  (${_endH! - _startH!}h)',
                style: const TextStyle(
                    color: kAccent, fontSize: 12, fontWeight: FontWeight.w700)),
            const SizedBox(width: 10),
            Text('\$${((_endH! - _startH!) * widget.pricePerHour).toStringAsFixed(0)}',
                style: const TextStyle(
        ...
        if (_canConfirm) ...[
          Container(
            ...
            child: Row(children: [
              ...
              _dot(),
              Text(_HomePageState._fmtDate(widget.dates[_dateIdx]),
                  style: const TextStyle(color: Colors.white70, fontSize: 12)),
              _dot(),
              Expanded(child: Text(_timeRangeLabel,
                  style: const TextStyle(
  ...
  Widget _dot() => Padding(
    ...
    child: Container(width: 3, height: 3,
        decoration: const BoxDecoration(
            color: kTextSub, shape: BoxShape.circle)),
  );
}
...
class _ImageCarouselState extends State<_ImageCarousel> {
  ...
  void _onDragEnd(DragEndDetails d) {
    ...
    if (v < -300)      _ctrl.animateToPage(c + 1, duration: const Duration(milliseconds: 300), curve: Curves.easeOutCubic);
    else if (v > 300)  _ctrl.animateToPage(c - 1, duration: const Duration(milliseconds: 300), curve: Curves.easeOutCubic);
    else               _ctrl.animateToPage(c,     duration: const Duration(milliseconds: 300), curve: Curves.easeOutCubic);
  }

  void _openFull(BuildContext ctx) => Navigator.of(ctx).push(PageRouteBuilder(
    opaque: false, barrierColor: Colors.black,
    transitionDuration: const Duration(milliseconds: 250),
    pageBuilder: (_, __, ___) => _FullScreenImageViewer(imageUrls: widget.imageUrls, initialIndex: _page),
    transitionsBuilder: (_, a, __, c) => FadeTransition(opacity: a, child: c),
  ));
        ...
        child: GestureDetector(
          ...
          child: Stack(fit: StackFit.expand, children: [
            PageView.builder(
              ...
              itemBuilder: (_, i) => Image.network(urls[i % urls.length], fit: BoxFit.cover,
            ...
            Container(decoration: const BoxDecoration(
              gradient: LinearGradient(
                  ...
                  begin: Alignment.topCenter, end: Alignment.bottomCenter, stops: [0.45, 1.0]),
            )),
            if (urls.length > 1)
              Positioned(bottom: 10, left: 0, right: 0,
                  child: Row(mainAxisAlignment: MainAxisAlignment.center,
                      children: List.generate(urls.length, (i) => AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                            color: i == _page ? kAccent : Colors.white.withOpacity(0.35),
            ...
            Positioned(top: 10, right: 12,
                child: GestureDetector(
                    ...
                    child: AnimatedContainer(
                        ...
                        width: 34, height: 34,
                        decoration: BoxDecoration(shape: BoxShape.circle,
                            color: _fav ? kAccent.withOpacity(0.85) : Colors.black.withOpacity(0.4),
                            border: Border.all(color: _fav ? kAccent : Colors.white24)),
  ...
  Widget _fallback() => Container(color: const Color(0xFF0D2040),
...
class _ClubImageCarouselState extends State<_ClubImageCarousel> {
    ...
    return ClipRRect(
      ...
      child: SizedBox(
        ...
        child: GestureDetector(
          ...
          child: Stack(fit: StackFit.expand, children: [
            PageView.builder(
              controller: _ctrl, itemCount: null,
              physics: const NeverScrollableScrollPhysics(),
              onPageChanged: (i) => setState(() => _page = i % urls.length),
              itemBuilder: (_, i) => Image.network(urls[i % urls.length], fit: BoxFit.cover,
                  errorBuilder: (_, __, ___) => Container(color: kCardAlt),
                  loadingBuilder: (_, c, p) => p == null ? c : Container(color: kCardAlt,
  ...
  Widget _openCloseBadge() {
    ...
    final isOpen = nowM >= parse(widget.club.openTime) && nowM < parse(widget.club.closeTime);
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 7, vertical: 3),
      decoration: BoxDecoration(
          color: Colors.black.withOpacity(0.55),
          borderRadius: BorderRadius.circular(20),
          border: Border.all(color: isOpen ? Colors.greenAccent.withOpacity(0.7) : Colors.redAccent.withOpacity(0.7))),
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(isOpen ? 'Open' : 'Closed',
            style: TextStyle(color: isOpen ? Colors.greenAccent : Colors.redAccent,
  ...
  Widget build(BuildContext context) {
    ...
    return FadeTransition(
      ...
      child: Scaffold(
        ...
        body: Stack(children: [
          GestureDetector(
            onVerticalDragUpdate: (d) => setState(() => _dragY += d.primaryDelta ?? 0),
            onVerticalDragEnd: (d) {
              if (_dragY.abs() > 100 || (d.primaryVelocity ?? 0).abs() > 800) _close();
              ...
              child: Opacity(
                ...
                child: PageView.builder(
                  ...
                  itemBuilder: (_, i) => InteractiveViewer(
                      minScale: 1.0, maxScale: 4.0,
                      child: Center(child: Image.network(urls[i % total], fit: BoxFit.contain,
                          errorBuilder: (_, __, ___) => const Center(
                              child: Icon(Icons.broken_image_outlined, color: Colors.white38, size: 64)),
                          loadingBuilder: (_, c, p) => p == null ? c : Center(
                ...
                child: AnimatedOpacity(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center,
                      children: List.generate(total, (i) => AnimatedContainer(
                          duration: const Duration(milliseconds: 250),
                          margin: const EdgeInsets.symmetric(horizontal: 3),
                          width: i == _current ? 20 : 7, height: 7,
                          decoration: BoxDecoration(
                              color: i == _current ? kAccent : Colors.white.withOpacity(0.4),
          ...
          Positioned(bottom: 16, left: 0, right: 0,
              child: AnimatedOpacity(
                  ...
                  duration: const Duration(milliseconds: 150),
                  child: const Center(child: Text('Swipe down to close',
                      style: TextStyle(color: Colors.white38, fontSize: 11))))),
        ]),
      ),
    );
...
class _GridPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final p = Paint()..color = kAccent.withOpacity(0.06)..strokeWidth = 1;
    const step = 28.0;
